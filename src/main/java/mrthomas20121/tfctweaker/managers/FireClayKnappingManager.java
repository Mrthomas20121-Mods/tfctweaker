...
public class FireClayKnappingManager implements IRecipeManager<KnappingRecipe> {
     ...
     * @docParam output <item:tfc:ceramic/unfired_fire_brick>
     */
    @ZenCodeType.Method
    public void addRecipe(String name, boolean outside_slot_required, String[] pattern, IItemStack output) {
        ...
        CraftTweakerAPI.apply(new ActionAddRecipe<>(this, new KnappingRecipe(Helpers.identifier(name), knappingPattern, output.getInternal(), TFCRecipeSerializers.FIRE_CLAY_KNAPPING.get())));
    }
}
