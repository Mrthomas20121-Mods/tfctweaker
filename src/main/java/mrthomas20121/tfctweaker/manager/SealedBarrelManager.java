...
public class SealedBarrelManager implements IRecipeManager<SealedBarrelRecipe> {
    ...
    @ZenCodeType.Method
    public void addRecipe(String name, int duration, IIngredientWithAmount input, IFluidStack inputFluid, IItemStack output, IFluidStack outputFluid, @ZenCodeType.Optional SoundEvent event) {
    ...
    @ZenCodeType.Method
    public void addRecipe(String name, int duration, IIngredientWithAmount input, CTFluidIngredient inputFluid, IItemStack output, IFluidStack outputFluid, @ZenCodeType.Optional SoundEvent event) {
